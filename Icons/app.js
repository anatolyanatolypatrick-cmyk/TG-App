  ...
  ru: {
    ...
    detail: {
      ...
      timelineSteps: {
        ...
        resultDistributed: "Результат распределен",
  ...
  en: {
    ...
    detail: {
      ...
      timelineSteps: {
        ...
        resultDistributed: "Result distributed",
...
const timelineByStatus = {
  ...
  PAYOUT_SENT: [
    ...
    { id: "resultDistributed", state: "current" },
  ],
  PAYOUT_CONFIRMED: [
    { id: "created", state: "complete" },
    { id: "detected", state: "complete" },
...
function timelineMarkerMode(step, cycle) {
  ...
  if (cycle.status === "CANCELLED" && step.id === "cancelled") return "cancelled";
  if (visualState !== "active") return visualState;
  if (cycle.status === "PAYOUT_CONFIRMED") return "completed-final";
...
function timelineMarker(step, cycle) {
  ...
  if (mode === "completed-final") {
    return `
      <span class="timeline-marker is-completed-final" aria-hidden="true">
        <svg class="timeline-completed-final" viewBox="0 0 24 24" fill="none">
          <circle class="segment segment-1" cx="12" cy="12" r="8.5" pathLength="120" />
          <circle class="segment segment-2" cx="12" cy="12" r="8.5" pathLength="120" />
          <circle class="segment segment-3" cx="12" cy="12" r="8.5" pathLength="120" />
        </svg>
      </span>
    `;
  }
  ...
  if (mode === "cancelled") {
    return `<span class="timeline-marker is-cancelled-final" aria-hidden="true"></span>`;
  }
